...
Usage:
  uv run x_discover.py --keywords "AI Agent,automation" --limit 5
  uv run x_discover.py --keywords "openclaw" --json
  uv run x_discover.py --keywords "LLM tool" --limit 10 --cache discover_cache.json
"""
